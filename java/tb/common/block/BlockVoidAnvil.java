...
public class BlockVoidAnvil extends Block implements IInfusionStabiliser, IRotationProvider
{
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random r) 
    {
    	...
    	int y = pos.getY();
    	int z = pos.getZ();
    	Thaumcraft.proxy.getFX().sparkle(x+r.nextFloat(), y+r.nextFloat(), z+r.nextFloat(), 2, 5, -0.1F);
    }
	...
	public BlockVoidAnvil setBlockName(String name)
	{
	...
	public BlockVoidAnvil setBlockTextureName(String tex)
	{
		texture = tex;
		return this;
	}
