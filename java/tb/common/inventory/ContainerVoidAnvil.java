...
public class ContainerVoidAnvil extends ContainerRepair{
	...
	public ContainerVoidAnvil(InventoryPlayer inv, final World w, final BlockPos pos, EntityPlayer p)
	{
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            {
                return (p_82869_1_.capabilities.isCreativeMode || p_82869_1_.experienceLevel >= ContainerVoidAnvil.this.maximumCost) && ContainerVoidAnvil.this.maximumCost > 0 && this.getHasStack();
            }
            public void onPickupFromSlot(EntityPlayer p_82870_1_, ItemStack p_82870_2_)
            {
                ...
                float breakChance = ForgeHooks.onAnvilRepair(p_82870_1_, p_82870_2_, ContainerVoidAnvil.this.inputSlots.getStackInSlot(0), ContainerVoidAnvil.this.inputSlots.getStackInSlot(1))*1.6F;
                ...
                if (ContainerVoidAnvil.this.materialCost > 0)
                {
                    ...
                    if (itemstack1 != null && itemstack1.stackSize > ContainerVoidAnvil.this.materialCost)
                    {
                        itemstack1.stackSize -= ContainerVoidAnvil.this.materialCost;
    ...
    {
        return this.w.getBlockState(new BlockPos(x,y,z)).getBlock() != TBBlocks.voidAnvil ? false : playerIn.getDistanceSq(x + 0.5D, y + 0.5D, z + 0.5D) <= 64.0D;
    }
