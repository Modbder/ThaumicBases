...
public class GuiVoidAnvil extends GuiContainer implements ICrafting
{
    ...
    private ContainerVoidAnvil anvil;
    private GuiTextField nameField;
    private InventoryPlayer playerInventory;

    public GuiVoidAnvil(InventoryPlayer p_i45508_1_, World worldIn, int x, int y, int z)
    {
        super(new ContainerVoidAnvil(p_i45508_1_, worldIn, new BlockPos(x,y,z), Minecraft.getMinecraft().thePlayer));
